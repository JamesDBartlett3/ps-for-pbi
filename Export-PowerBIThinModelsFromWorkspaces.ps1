<#
  ...
  .DESCRIPTION
		...
		It can be used to export a single Thin Model by specifying the DatasetId, WorkspaceId, BlankPbix, and OutFile parameters.
  ...
  .EXAMPLE
    ...
    .\Export-PowerBIThinModelsFromWorkspaces.ps1 -DatasetId "00000000-0000-0000-0000-000000000000" -WorkspaceId "00000000-0000-0000-0000-000000000000" -BlankPbix "C:\blank.pbix" -OutFile "C:\new.pbix"
